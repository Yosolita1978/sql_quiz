...
SELECT melon_type, common_name, price AS dollar_price, price*0.73 AS euro_price FROM melons;
...
SELECT common_name, melon_type, quantity, unit_price, total_price FROM melons JOIN order_items ON melons.id = melon_id WHERE order_items.order_id = 2725;